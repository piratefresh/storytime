...
import { UploadResult, useDropZone, useFileUpload, useUploader } from "./hooks";
...
export const ImageUploader = ({
  ...
  uploadImageFn: (file: File) => Promise<UploadResult>;
}) => {
  const { loading, uploadFile } = useUploader({ onUpload, uploadImageFn });
